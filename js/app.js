...
var theToggled = document.getElementById('toggled');
...
$('#cert-list_item').each(function(){
    var cnt = $('#cert-list_item').index( $(this) );
    var txt = $(this).text();
    if ($.trim(txt)==''){
        $(this).hide();
